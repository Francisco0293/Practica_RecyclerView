package mx.edu.itm.link.practica_recyclerview

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import mx.edu.itm.link.practica_recyclerview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val fakeVideoData: Array<JSONObject> = arrayOf(
            ...
            JSONObject("{\"title\": \"Another awesome video title\", \"channel\": \"Channel\", \"views\": \"8k views\", \"datePosted\": \"5 days ago\", \"duration\": \"05:00\"}"),
